...
we can choose $$z$$ from $$span(v_1,...,v_{r+1})$$ and $$z= \Sigma k_iv_i,Bz=0,\parallel z\parallel=1(\Sigma k_i^2=1)$$
...
if such X exist,let define $$\parallel A-X\parallel_2=2\epsilon>0$$
